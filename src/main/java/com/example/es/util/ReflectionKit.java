...
public final class ReflectionKit {
    ...
    public static Object getMethodValue(Class<?> cls, Object entity, String str) {
        ...
        try {
            Assert.notEmpty(fieldMaps, String.format("Error: NoSuchField in %s for %s.  Cause:", cls.getSimpleName(), str));
            Method method = cls.getMethod(guessGetterName(fieldMaps.get(str), str));
            return method.invoke(entity);
        } catch (NoSuchMethodException e) {
            throw new EsCommonException(String.format("Error: NoSuchMethod in %s.  Cause:", e, cls.getSimpleName()));
        } catch (IllegalAccessException e) {
            throw new EsCommonException(String.format("Error: Cannot execute a private method. in %s.  Cause: %s", e, cls.getSimpleName()));
        } catch (InvocationTargetException e) {
            throw new EsCommonException("Error: InvocationTargetException on getMethodValue.  Cause:" + e);
        }
    }
    ...
    public static Object getFieldValue(Object entity, String fieldName) {
        ...
        try {
            ...
            Assert.notNull(field, String.format("Error: NoSuchField in %s for %s.  Cause:", cls.getSimpleName(), fieldName));
            field.setAccessible(true);
            return field.get(entity);
        } catch (ReflectiveOperationException e) {
            throw new EsCommonException(String.format("Error: Cannot read field in %s.  Cause: %s", e, cls.getSimpleName()));
        }
    }
    ...
    public static Method getMethod(Class<?> cls, Field field) {
        try {
            ...
            throw new EsCommonException(String.format("Error: NoSuchMethod in %s.  Cause: %s", e, cls.getName()));
        }
    }
